...
static LCM_Init_Code init_data_hx8369b_dtc[] = {
	{LCM_SEND(6), {4, 0, 0xB9, 0xFF, 0x83, 0x69}},
	...
	{LCM_SEND(18), {16, 0, 0xBA,
            ...
            0x21, 0x21, 0x9A, 0x1A, 0x8F}},
    	{LCM_SEND(95), {93, 0, 0xD5,
    		0x00, 0x00, 0x0C, 0x00, 0x00, 0x00, 0x00, 0x12, 0x30, 0x00, 
    		0x00, 0x00, 0x01, 0x4C, 0x34, 0x3D, 0x15, 0x10, 0x01, 0x48, 
    	...
    	{LCM_SEND(2), {0x3A, 0x70}},
	{LCM_SEND(2), {0x36, 0x00}},
	{LCM_SEND(15), {13, 0, 0xB1,
		0x13, 0x83, 0x77, 0x00, 0x10, 0x10, 0x1B, 0x1B, 0x0C, 0x1A,
		0x20, 0xD6}},
	{LCM_SEND(7), {5, 0, 0xB3, 
		0x83, 0x00, 0x3A, 0x17}},
	{LCM_SEND(2), {0xB4, 0x00}},
	...
	{LCM_SEND(130), {128, 0, 0xC1,
           0x01, 0x00, 0x06, 0x0D, 0x15, 0x1D, 0x25, 0x2D, 0x35, 0x3D, 
	...
	{LCM_SEND(38), {36, 0, 0xE0,
            0x00, 0x01, 0x04, 0x0F, 0x10, 0x3F, 0x1B, 0x33, 0x00, 0x0D, 
            0x11, 0x17, 0x1A, 0x17, 0x17, 0x13, 0x17, 0x00, 0x01, 0x04, 
            0x0F, 0x0F, 0x3F, 0x1B, 0x32, 0x00, 0x0D, 0x11, 0x16, 0x19, 
            0x17, 0x16, 0x12, 0x17, 0x01}},
...
static LCM_Init_Code esd_init_data_hx8369b_dtc[] = {
	{LCM_SEND(6), {4, 0, 0xB9, 0xFF, 0x83, 0x69}},
...
static int32_t hx8369b_mipi_init(struct panel_spec *self)
{
	...
	if(self->esd_status==1){
		if( -200 < get_temp_from_ps_battery()) /* -20 decree */
		{
			if(lcd_id_from_uboot==0x55AF90){		
			...
			else if(lcd_id_from_uboot==0x55BC90){
				...
				init=esd_init_data_hx8369b_dtc;
				self->seq_size = ARRAY_SIZE(esd_init_data_hx8369b_dtc);
				printk("sprdfb: hx8369b_esd_init at low temp\n");
			}
		}
		else
...
static struct timing_rgb lcd_hx8369b_dtc_mipi_timing = {
	.hfp = 65, //170,  /* unit: pixel */
	.hbp = 65, //110,
	.hsync = 40,// 65,
	.vfp = 6, /*unit: line*/
	.vbp = 19,
...
static struct info_mipi lcd_hx8369b_dtc_mipi_info = {
	.work_mode  = SPRDFB_MIPI_MODE_VIDEO,
	.video_bus_width = 24, /*18,16*/
	.lan_number = 	2,
	.phy_feq =500*1000,
	...
	.color_mode_pol = SPRDFB_POLARITY_NEG,
	.shut_down_pol = SPRDFB_POLARITY_NEG,
	.timing = &lcd_hx8369b_dtc_mipi_timing,
	.ops = NULL,	
};

struct panel_spec lcd_hx8369b_dtc_mipi_spec = {
	.width = 480,
	.height = 800,
	.type = LCD_MODE_DSI,
	.direction = LCD_DIRECT_NORMAL,
	.is_clean_lcd = true,	
	.info = {
		.mipi = &lcd_hx8369b_dtc_mipi_info
	},
	.ops = &lcd_hx8369b_mipi_operations,
};
struct panel_cfg lcd_hx8369b_dtc_mipi = {
	/* this panel can only be main lcd */
	.dev_id = SPRDFB_MAINLCD_ID,
	.lcd_id = 0x55C090,
	.lcd_name = "lcd_hx8369b_dtc_mipi",
	.panel = &lcd_hx8369b_dtc_mipi_spec,
};
...
ssize_t lcd_panelName_show(struct device *dev, struct device_attribute *attr, char *buf)
{
	...
	if(lcd_id_from_uboot==0x55C090)
		return sprintf(buf, "hx8369b_dtc");
}
...
ssize_t lcd_type_show(struct device *dev, struct device_attribute *attr, char *buf)
{
	...
	if(lcd_id_from_uboot==0x55C090)
		return sprintf(buf, "INH_%x%x%x",0x55, 0xC0, 0x90);
}
...
static int __init lcd_hx8369b_mipi_init(void)
{
	...
	if(lcd_id_from_uboot==0x55AF90)
		...
		return sprdfb_panel_register(&lcd_hx8369b_dtc_mipi);
}
